...
export const HomeScreen: React.FC<HomeScreenProps> = ({ snapshot, onNavigate }) => {
  ...
  return (
    <div className="space-y-4 animate-in fade-in duration-300">
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-xs text-slate-400 font-medium">
            {location.state} • {leadTime} Lead Horizon
          </p>
        </div>

        <div className="text-right">
          <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-slate-800/80 border border-white/10 text-[11px] font-mono text-slate-300">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-b from-slate-800/90 via-[#0f1b33]/90 to-[#091024]/95 border border-sky-500/20 p-5 shadow-2xl radar-glow">
        {/* Ambient background glow */}
        <div className="absolute -top-16 -right-16 w-44 h-44 rounded-full bg-sky-500/15 blur-3xl pointer-events-none"></div>
        <div className="absolute -bottom-16 -left-16 w-44 h-44 rounded-full bg-purple-500/10 blur-3xl pointer-events-none"></div>
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between">
            ...
            <span className="text-[11px] font-mono text-slate-400">Next {leadTime}</span>
          </div>
          ...
          <div className="grid grid-cols-3 gap-2 pt-3 border-t border-white/[0.08]">
            <div className="flex items-center gap-2 p-2 rounded-xl bg-slate-900/60 border border-white/5">
              ...
              <div>
                <div className="text-[10px] text-slate-400 uppercase font-mono">Temp</div>
            ...
            <div className="flex items-center gap-2 p-2 rounded-xl bg-slate-900/60 border border-white/5">
              ...
              <div>
                <div className="text-[10px] text-slate-400 uppercase font-mono">Wind</div>
      ...
      {/* Confidence Meter & Model Agreement Grid */}
        ...
        <div className="glass-card rounded-2xl p-3.5 flex flex-col justify-between">
          ...
          <div className="my-2.5">
            <div className="w-full bg-slate-800 rounded-full h-2.5 overflow-hidden p-0.5 border border-white/5">
              <div
                className="bg-gradient-to-r from-teal-400 to-emerald-400 h-full rounded-full transition-all duration-700 shadow-[0_0_10px_rgba(16,185,129,0.5)]"
          ...
          <div className="text-[10px] text-slate-400 flex items-center justify-between">
            <span className="font-semibold text-emerald-300">High Confidence</span>
            <span>Error ±{snapshot.explainability.rmseComparison.find((m) => m.isBlended)?.rmse}mm</span>
          </div>
        </div>

        {/* Model Agreement Meter Card */}
        <div className="glass-card rounded-2xl p-3.5 flex flex-col justify-between">
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-semibold text-slate-300 flex items-center gap-1">
          ...
          <div className="my-2 flex items-center justify-between">
            <div className="text-[11px] text-slate-300">
              <span className="font-bold text-white">4 / 4</span> Models Converged
            </div>
          ...
          <div className="text-[10px] text-slate-400 truncate">
            {agreementLevel === 'HIGH'
              ...
              : 'Moderate spread; ensemble dampens risk'}
          </div>
        </div>
      </div>

      {/* Live Model Weight Contribution Strip */}
      <div className="glass-card rounded-2xl p-4">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-1.5">
            <Cpu className="w-4 h-4 text-purple-400" />
            <h3 className="text-xs font-bold text-slate-200 uppercase tracking-wider">
              Dynamic Model Contribution
            </h3>
          </div>
          <button
        ...
        <div className="w-full h-3 rounded-full overflow-hidden flex bg-slate-800 p-0.5 gap-0.5 border border-white/5">
          {models.map((m) => (
            <div
              key={m.id}
        ...
        <div className="grid grid-cols-4 gap-1.5 mt-3">
          {models.map((m) => (
            <div key={m.id} className="text-center p-1.5 rounded-xl bg-slate-900/60 border border-white/5">
      ...
      {/* Explainable AI Quick Teaser Card */}
      <div className="glass-card rounded-2xl p-4 border-sky-500/20 bg-gradient-to-r from-sky-950/20 to-purple-950/20">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <div className="text-xs font-bold text-slate-200">Explainable AI Intelligence</div>
            ...
            >
              <span>View Full Skill Breakdown & Verification</span>
